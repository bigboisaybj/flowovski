...
if(isset($_POST['day'])){
  ...
  $orderInput = mysqli_query($db, "INSERT INTO sales VALUES ('0', '$tempDay', '$tempTime', '$tempUser', '$tempMerchant', '$tempProduct', '$tempPrice', '$tempLat', '$tempLong', '$tempExtras' ,'TBC', 'TBC', 'TBC', 'TBC', 'TBC', 'TBC', 'TBC', 'TBC', 'TBC', 'TBC', 'TBC', 'TBC', 'TBC', 'Yes')");
